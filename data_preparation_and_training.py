...
def build_kumbh_dataset():
    ...
    sourced_data = [
        {
            ...
            "has_expanded_ghat": 0,
            "throughput_tier": 3,  # Bottlenecked (pre-2027 expansion)
            "days_since_start": 15,
    ...
    # 2. Domain-Driven Synthetic Data Generation (modeling Nashik 2027)
    n_synthetic = 440
    sectors = [
        "Ram Kund - Panchavati",
        "Tapovan",
...
def train_and_evaluate_models():
    """
    Loads dataset, trains Logistic Regression, Random Forest, XGBoost (or GradientBoosting),
    evaluates metrics via 5-fold CV & test set, prints feature importances, and saves pipeline.
    """
    ...
    for name, model in models.items():
        ...
        print("  Confusion Matrix (Low, Medium, High, Extreme):")
        print(cm)
